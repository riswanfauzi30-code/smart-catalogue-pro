    ...
    <div style={{minHeight:"100vh",background:"#F1F5F8",fontFamily:"system-ui"}}>
      <header style={{background:"#0066AE",color:"white",position:"sticky",top:0,zIndex:20}}>
        <div style={{maxWidth:1200,margin:"0 auto",padding:"14px 20px",display:"flex",gap:16,alignItems:"center"}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            <div style={{width:38,height:38,background:"white",borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center",color:"#0066AE",fontWeight:"900",fontSize:14}}>RF</div>
            <div style={{fontWeight:"900",fontSize:16,lineHeight:1.1}}>RF Smart Catalogue</div>
          </div>
      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"20px"}}>
        <div style={{background:"white",borderRadius:16,padding:20,borderLeft:"6px solid #0066AE"}}>
          <h1 style={{color:"#0066AE",fontWeight:"900",fontSize:18}}>Katalog {filtered.length} Produk</h1>
        </div>
